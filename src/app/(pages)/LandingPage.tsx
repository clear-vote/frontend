...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen pt-32 flex flex-col items-center the-fancy-background">
      ...
      <br></br>
      <h1 className="text-white font-bold">Clearvote will return for the 2025 General Election on October 27th, 2025:</h1>
      <CountdownToDate targetDate="2025-10-26T59:59:59" />
      <br/>
