...
export default function AboutPage() {
    return (
        <div className="flex justify-center p-2">
            <div className="mb-4 w-full max-w-[calc(100%-2rem)] flex flex-col items-center">
                ...
                <br></br>
                <Image src="/images/star-photo.jpg" alt="Team-photo" width={400} height={200} />
                <br></br>
                <h1 className="text-3xl font-semibold my-8">Why?</h1>
                <p>
                ...
                <br></br>
                <h1 className="text-3xl font-semibold my-8">How?</h1>
                <br></br>
                <p>
